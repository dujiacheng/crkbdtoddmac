...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 KC_LCTL,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                       KC_H    ,KC_J    ,KC_K    ,KC_L  ,KC_QUOT , KC_ENT ,
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                      KC_LGUI, NAV, LOW_SPC, MT(MOD_RSFT, KC_SPC) ,  RAISE  ,KC_LALT
                                      //`----------KC_LGUI----------'  `--------------------------'
  ),     
  [_WINDOWS] = LAYOUT(
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
 KC_LCTL,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                           KC_H    ,KC_J    ,KC_K    ,KC_L    ,KC_QUOT , KC_LGUI ,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
 KC_LSFT,   KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,                             KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH ,OSL_FUN ,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                        GUI_ESC, WINNAV,  KC_SPC,    KC_BSPC,  RAISE  ,KC_SPC
                                      //`----------KC_LGUI----------'  `--------------------------'
  ),     


  [_WINNAV] = LAYOUT( 
       _______, KC_ESC,KC_MAC_CLOSE,TAB_R, APP_SWITCH_FRWD,SCREENSHOT,                    KC_HOME,   SPACE_L,    KC_UP,   SPACE_R,     KC_BSPC,_______,
       _______,KC_ENT,KC_MAC_SAVE,MC_D,KC_MAC_FIND,TRANSLATE,               KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT,OSM(MOD_LCTL),
       _______,KC_MAC_UNDO,KC_MAC_CUT,KC_WIN_COPY,KC_WIN_PASTE,PYCRUN,             KC_END, KC_PGDN, KC_PGUP, SW_LANG,  KC_DEL,_______,
                                   OS_ALT,  _______, _______,              _______,KC_TRNS, _______
  ),
